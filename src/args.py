...
def get_args_func() -> argparse.Namespace:
    ...
    parser.add_argument("--output", type=str, default="results", help="The path at which to save the dataset")
    ...
    parser.add_argument("--workers", type=int, default=8, help="The number of worker threads to use to generate the dataset")
