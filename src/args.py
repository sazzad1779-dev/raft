...
def get_args_func() -> argparse.Namespace:
    ...
    parser.add_argument("--datapath", type=Path, default="md", help="If a file, the path at which the document is located. If a folder, the path at which to load all documents")
    ...
    parser.add_argument("--distractors", type=int, default=2, help="The number of distractor documents to include per data point / triplet")
    parser.add_argument("--p", type=float, default=0.9, help="The percentage that the oracle document is included in the context")
    parser.add_argument("--questions", type=int, default=4, help="The number of data points / triplets to generate per chunk")
    parser.add_argument("--chunk_size", type=int, default=500, help="The size of each chunk in number of tokens")
    parser.add_argument("--doctype", type=str, default="md", help="The type of the document, must be one of the accepted doctypes", choices=docTypes)
    ...
    parser.add_argument("--workers", type=int, default=4, help="The number of worker threads to use to generate the dataset")
